...
var TravisCi = require('travis-ci');
...
/**
 * [createTravisProject Connect newly created git-repo with TravisCI]
 * @param  {Object} slug         [URL to git repo]
 * @param  {Object} githubConfig [.gitconfig information]
 * @return {Promise}              [Promise for authentication]
 */
Travis.createTravisProject = function createTravisProject(slug, githubConfig) {
